      ...
      <div class="row">
        <div class="col-md-12">
          <div class="owl-carousel owl-carousel-fullwidth">
            <div class="item">
              <a href="#">
             <img src="<?php echo get_theme_file_uri() ?>/assets/image/slider_1.jpg"alt="Free Website Template by GetTemplates.co">
            ...
            <div class="item">
              <a href="#">
                <img src="<?php echo get_theme_file_uri() ?>/assets/image/slider_2.jpg" alt="Free Website Template by GetTemplates.co">
                <div class="slider-copy">
            ...
            <div class="item">
              <a href="#">
                <img src="<?php echo get_theme_file_uri() ?>/assets/image/slider_3.jpg" alt="Free Website Template by GetTemplates.co">
                <div class="slider-copy">
            ...
            <div class="owl-carousel owl-carousel-carousel">
              <div class="item">
                <div class="gtco-item">
                  ...
                  <h2><a href="#">Instalación de vidrios templados al multirascacielos World Wide Web.</h2></a>
                  <p class="role"></p>
                </div>
              </div>
              <div class="item">
                <div class="gtco-item">
                  ...
                  <h2><a href="#">Instauración del uso de vidrios templados en todos los palacios de gobierno en América latina.</h2></a>
                  <p class="role"></p>
                </div>
              </div>
              <div class="item">
                <div class="gtco-item">
                  ...
                  <h2><a href="#">Alianza con la marca Toyrd para la incorporación de vidrios templados en todos sus vehículos.</h2></a>
                  <p class="role"></p>
                </div>
              </div>
